...
import LogoutAlert from "./AllertLogout"; 

function SidebarUser() {
  const location = useLocation();
  const [showLogoutAlert, setShowLogoutAlert] = useState(false); // ⬅️ state alert logout
    ...
    <>
      <aside className="w-72 bg-gradient-to-b from-[#B091D1] to-[#5A4B6B] text-white px-6 py-10 flex flex-col items-center">
        ...
        <div className="mt-22 w-full text-center">
          ...
          <button
            onClick={() => setShowLogoutAlert(true)} // buka alert
