    ...
    <div className="flex min-h-screen bg-white font-raleway">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="px-10 py-6 overflow-y-auto flex-1">
          <h2 className="text-2xl font-bold text-[#5A4B6B] mb-1">UMUM</h2>
            ...
            {dataPenyaluran.map((item) => {
              ...
              return (
                ...
                >
                  {/* Lihat Detail */}
                  <button
                    onClick={() => navigate(`/user/penyaluran/detailpenyaluranumum/${item.id}`)}
...
export default BuktiPenyaluranUmum;
