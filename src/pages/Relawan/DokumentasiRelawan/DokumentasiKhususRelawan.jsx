...
const DokumentasiKhususRelawan = () => {
        ...
        <main className="p-6 max-w-8xl mx-auto w-full">
          <div className="bg-[#f0f0f0] rounded-2xl shadow p-6">
            ...
            <div className="flex justify-between items-center mb-6">
              ...
              <button
                onClick={() => navigate("/relawan/dokumentasi/uploaddokumentasikhususrelawan")}
              ...
              {dokList.map((item) => {
                ...
                return (
                  <div
                    key={item.id}
                    onClick={() =>
                      navigate(`/relawan/dokumentasi/detailkhusus/${item.id}`)
                    }
                  ...
                  >
                    ...
                    >
                      <button
                        onClick={() =>
                          navigate(`/relawan/dokumentasi/editdokumentasikhususrelawan/${item.id}`)
                        }
                      >
                        <img
                          src={editIcon}
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-sm text-gray-800 mb-2">
                        <span className="font-semibold">Penyalur:</span> Relawan
                      </p>
...
export default DokumentasiKhususRelawan;
