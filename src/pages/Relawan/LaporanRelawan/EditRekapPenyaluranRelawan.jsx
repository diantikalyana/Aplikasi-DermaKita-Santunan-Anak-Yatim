...
const EditRekapPenyaluranRelawan = () => {
  ...
  const [preview, setPreview] = useState(data?.foto || "");
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Rekap berhasil diperbarui:", Object.fromEntries(payload));

    setShowAlert(true);
    setTimeout(() => {
      setShowAlert(false);
      navigate("/relawan/laporan/rekappenyaluran");
    }, 2000);
  };
    ...
    <div className="flex items-center justify-center min-h-screen bg-[#f0f0f0] font-raleway relative">
      ...
      <div className="bg-white rounded-xl shadow p-8 border border-gray-200 w-full max-w-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {/* Nama Anak */}
          <div>
            <label className="block text-sm font-semibold mb-1">Nama Anak</label>
            <input
              type="text"
              name="nama_anak"
          ...
          {/* Nama Penyalur */}
          <div>
            <label className="block text-sm font-semibold mb-1">Penyalur</label>
            <input
              type="text"
              name="nama_penyalur"
          ...
          <div className="flex justify-center gap-4 pt-4">
            ...
            <button
              type="button"
              onClick={() => navigate("/relawan/laporan/rekappenyaluran")}
...
export default EditRekapPenyaluranRelawan;
