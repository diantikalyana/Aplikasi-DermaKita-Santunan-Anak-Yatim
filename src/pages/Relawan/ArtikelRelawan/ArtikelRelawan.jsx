...
const dummyArtikelList = [
  {
    ...
    deskripsi: `Alif, 7 tahun, anak yatim yang menderita kanker darah. Ia sangat membutuhkan bantuan dana untuk menjalani pengobatan intensif di rumah sakit dengan total kebutuhan Rp50.000.000.`,
  ...
  },
  {
    ...
    deskripsi: `Hanum adalah anak yatim berusia 9 tahun yang sedang sakit keras dan membutuhkan uluran tangan kita semua untuk biaya pengobatan sebesar Rp20.000.000.`,
    ...
    <div className="flex min-h-screen bg-[#f5f5f5] text-[#111827] font-raleway">
      ...
      <div className="flex flex-col flex-1">
        ...
        <main className="p-6 max-w-5xl mx-auto w-full">
          <h1 className="text-2xl font-bold text-[#493953] mb-6">Donasi Urgensi</h1>
