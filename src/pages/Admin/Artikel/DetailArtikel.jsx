...
const DetailArtikel = () => {
  ...
  return (
    <div
      className="flex min-h-screen bg-white text-[#111827] relative"
    ...
    >
      ...
      <main className="relative bg-[#f0f0f0] rounded-2xl shadow p-6 my-8 max-w-5xl w-full mx-auto">
          {/* Tombol Back */}
          <button
            onClick={() => navigate("/admin/artikel")}
            className="absolute -top-5 left-5 flex items-center text-purple-600 hover:text-gray-800"
          >
            <img src={arrowIcon} alt="Kembali" className="w-8 h-8" />
