...
const DetailDokumentasiKhusus = () => {
  const { id } = useParams();
  const navigate = useNavigate();

  // Dummy data sama dengan DokumentasiKhusus
  const dummyData = [
    {
      id: 1,
      foto: FotoEnam,
      ...
      target: 35000000,
      deskripsi:
        "Pada kesempatan yang penuh makna ini, DermaKita dengan penuh kepedulian menyalurkan bantuan sebesar Rp35.000.000 untuk mendukung perjuangan seorang anak yatim yang saat ini tengah berjuang melawan penyakit kanker otak. Perjalanan yang ia jalani bukanlah hal mudah. Selama lebih dari satu tahun terakhir, ia dengan sabar menahan rasa sakit yang datang silih berganti, tanpa banyak mengeluh atas sakit yang dideritanya.",
    },
    {
      id: 2,
      foto: FotoDua,
...
export default DetailDokumentasiKhusus;
